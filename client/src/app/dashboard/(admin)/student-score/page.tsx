...
const StudentScore = () => {
    ...
    const filteredUsers = useMemo(() => {
        return users.filter((user) => {
            ...
            const matchesSearch =
                searchText === '' || name.toLowerCase().includes(searchText.toLowerCase()) || mssv.includes(searchText);
        ...
        <div className="flex gap-8">
            <div className={isScoreExpanded ? 'w-1/3' : 'w-full'}>
                <Card
                    ...
                    extra={
                        <div className="flex items-center gap-2">
                            <button onClick={clearFilters} className="text-xs text-gray-500 hover:text-blue-500">
                                Xóa bộ lọc
                            </button>
                            {scoreUserId && (
                                <button
                ...
                >
                    ...
                    {loading ? (
                        ...
                        <Empty description="Không tìm thấy sinh viên nào" className="py-8" />
                    ) : (
                                        ...
                                        <List.Item.Meta
                                            ...
                                            title={
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    {user._id === scoreUserId && <Tag color="blue">Đang xem</Tag>}
                                                </div>
                                            }
                                            description={
