...
const TrainingProgramPage = () => {
    ...
    const fixedMajors = ['An toàn thông tin', 'Mạng máy tính & Truyền thông dữ liệu'];
    const fixedMajorCodes = ['ATTT', 'MMT'];
    const fixedCourses = ['Khóa 2021 - K16', 'Khóa 2022 - K17', 'Khóa 2023 - K18', 'Khóa 2024 - K19'];
    ...
    return (
        <div className="p-6 max-w-6xl mx-auto">
            ...
            {toast && (
                <div
                    className={`mb-4 px-4 py-2 rounded text-white shadow ${
            ...
            <div className="mb-6 flex flex-col md:flex-row gap-2 items-center justify-between">
                <form className="flex flex-wrap gap-2 items-center" onSubmit={handleUpload}>
                    ...
                    <button
                        ...
                        disabled={uploading}
                    >
                        {uploading ? 'Đang tải...' : 'Upload file Excel'}
                    </button>
                </form>
            </div>
                            ...
                            pagedPrograms.map((p) => (
                                <tr key={p._id} className="hover:bg-blue-50 transition">
                                    ...
                                    <td className="border px-2 py-2 text-center">
                                        <button
                                            className="text-green-700 hover:underline hover:text-green-900 font-semibold mr-2"
                                            onClick={() => setDetail(p)}
                                        >
                                            Chi tiết
                                        </button>
                                        <button
                                            className="text-blue-700 hover:underline hover:text-blue-900 font-semibold mr-2"
                                            onClick={() => openEdit(p)}
                                        >
                                            Sửa
                                        </button>
                                        <button
                                            className="text-red-700 hover:underline hover:text-red-900 font-semibold"
                ...
                <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50 transition">
                    <div className="bg-white p-6 rounded-lg shadow w-full max-w-2xl max-h-[80vh] overflow-y-auto">
                        <h2 className="text-xl font-bold mb-4">
                            Danh sách môn học ({detail.major} - {detail.course})
                        </h2>
                        ...
                        <button className="px-4 py-2 bg-gray-300 rounded" onClick={() => setDetail(null)}>
                            Đóng
                        </button>
                    </div>
                </div>
