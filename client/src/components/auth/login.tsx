            ...
            <main className="flex flex-col items-center w-screen flex-1 px-20 text-center mt-9 min-w-[764px]">
                <div className="rounded-2xl shadow-2xl h-[520px] flex max-w-3xl ">
                    <div className="md:w-4/5 p-6">
                        ...
                        <div>
                            <form className="flex flex-col gap-2" onSubmit={onFinish}>
                                <div>
                                    <input
                                        className="p-2 rounded-xl border w-full text-left"
                                        type="email"
                                        name="email"
                                        placeholder="Email"
                                ...
                                <div className="relative">
                                    <input
                                        className="p-2 mt-2 rounded-xl border w-full text-left"
                                        type="password"
                                        name="password"
                                ...
                                <button
                                    type="submit"
                                    className="bg-[#0077FF] hover:scale-110 mt-4 rounded-lg text-white px-4 py-1 inline-block font-semibold hover:bg-[#2e7bd9] hover:text-white"
                                >
                                    Đăng nhập
                                </button>
                                ...
                                <button
                                    ...
                                    onClick={() =>
                                        (window.location.href = `${process.env.NEXT_PUBLIC_BackendURL}/api/auth/google/login`)
                                    }
                                >
                    ...
                    <div className=" bg-[#71ACF2] md:block hidden justify-center items-center rounded-md max-w-3xl relative">
                        <h2 className="text-3xl absolute ml-4 mt-9 text-white font-bold mb-2">
