...
//                 or
//                 </div>
//                 <button type="button" className="flex items-center justify-center w-full max-w-xs border border-gray-300 rounded-lg shadow-md py-2 px-4 bg-white hover:bg-gray-100 transition-all duration-300 mt-1" onClick={() => signIn("google", { callbackUrl: "/dashboard" })}>
...
export default function SignIn() {
  return (
    ...
    >
<button type="submit" className="flex items-center justify-center w-full max-w-xs border border-gray-300 rounded-lg shadow-md py-2 px-4 bg-white hover:bg-gray-100 transition-all duration-300 mt-1">
                  <FcGoogle className="text-2xl mr-2" />
                 <span className="text-black font-medium">Login via Google</span>
               </button>    </form>
  )
